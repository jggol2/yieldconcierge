...
const BANKS = [
  ...
  { id:"axos",            name:"Axos Bank",               account:"ONE Savings (bundle)",        baseApy:1.00, branch:false, debit:true,  investing:false, fee:0, feeWaivable:false, minOpen:0,   slowTransfer:false, affiliateUrl:"https://www.axosbank.com/Personal/Savings?ref=REPLACE_CJ_ID",               notes:"Highest conditional rate (4.21%) for users meeting DD + balance mins. Requires Axos ONE Checking bundle. 95,000+ fee-free ATMs. No investing. Base rate is only 1% without conditions." },
  ...
  { id:"cit",             name:"CIT Bank",                account:"Platinum Savings",            baseApy:0.25, branch:false, debit:false, investing:false, fee:0, feeWaivable:false, minOpen:100, slowTransfer:false, affiliateUrl:"https://www.cit.com/cit-bank/bank/savings/platinum-savings/?ref=REPLACE_CJ_ID", notes:"3.75% for $5,000+ balances. Only 0.25% below that threshold. No debit. $100 min to open. Good for disciplined savers keeping higher balances." },
  ...
  { id:"bask",            name:"Bask Bank",               account:"Interest Savings",            baseApy:3.75, branch:false, debit:false, investing:false, fee:0, feeWaivable:false, minOpen:0,   slowTransfer:false, affiliateUrl:"https://www.baskbank.com/savings?ref=REPLACE_DIRECT_ID",                   notes:"Division of Texas Capital Bank. Flat 3.75%. Promo 4.00% for new accounts with $10k+ avg monthly balance through May 31, 2026 (open by Mar 31, 2026). Also offers American Airlines miles variant." },
