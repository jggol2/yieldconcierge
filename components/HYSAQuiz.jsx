...
const BANKS = [
  ...
  { id:"openbank",        name:"Openbank",                account:"High Yield Savings",          baseApy:3.80, branch:false, debit:false, investing:false, fee:0, feeWaivable:false, minOpen:500, slowTransfer:false, affiliateUrl:null,                                                                         notes:"Digital subsidiary of Santander. No conditions for 3.80% (reduced from 4.09% in 2026 — verified on Openbank's own site June 2026). $500 min to open. Online/app only. No debit. Transfers typically 1-2 days. Note: Santander and Openbank deposits are combined for FDIC limit purposes (same FDIC cert)." },
  { id:"bread",           name:"Bread Savings",           account:"High Yield Savings",          baseApy:3.95, branch:false, debit:false, investing:false, fee:0, feeWaivable:false, minOpen:100, slowTransfer:true,  affiliateUrl:"https://www.breadsavings.com/?ref=REPLACE_CJ_ID",                           notes:"Flat 3.95% APY (verified directly on breadsavings.com June 2026; aggregators still showing stale 4.00%). $100 min to open, no monthly fees. No debit or checking. Online only. Paper statements $5. ACH transfers can take 1-3 business days. Not ideal if you need fast access. Division of Comenity Capital Bank (part of Bread Financial); FDIC up to $250k." },
  ...
  { id:"barclays",        name:"Barclays",                account:"Tiered Savings Account",      baseApy:3.65, branch:false, debit:false, investing:false, fee:0, feeWaivable:false, minOpen:0,   slowTransfer:true,  affiliateUrl:"https://www.banking.barclaysus.com/tiered-savings.html?ref=REPLACE_CJ_ID",  notes:"Tiered rate: 3.65% APY on balances under $250,000; 3.80% APY on balances $250,000+ (reduced from 3.70%/3.85% in mid-2026). Rate is applied to the entire balance based on end-of-day tier. No monthly fees, no minimum to open. No debit card, no checking account — ACH transfers only, typically 2–3 business days. No branch access. Online only." },
  { id:"etrade",          name:"E*TRADE",                 account:"Premium Savings",             baseApy:3.50, branch:false, debit:false, investing:true,  fee:0, feeWaivable:false, minOpen:0,   slowTransfer:false, affiliateUrl:"https://us.etrade.com/bank/premium-savings-account?ref=REPLACE_CJ_ID",     notes:"Backed by Morgan Stanley. Standard 3.50% APY (increased from 3.35% — bucking the broader downward trend in mid-2026). Promo 3.75% for 6 months on new money (code SAVE26) + cash bonus up to $2,000. Seamless brokerage integration." },
  ...
  { id:"western_alliance", name:"Western Alliance Bank", account:"High-Yield Savings Premier",  baseApy:3.80, branch:false, debit:false, investing:false, fee:0, feeWaivable:false, minOpen:500, slowTransfer:true,  affiliateUrl:null,                                                                         notes:"Major FDIC bank ($90B+ assets). Flat 3.80% no conditions. $500 min to open ($1 if opened via Raisin). ACH only — one linked external account. Deposits take 5 business days. No debit. Well-reviewed. Joint accounts available. Promo: cash bonus up to $2,000 with code GIFT (tiered by deposit size — verify current terms at signup)." },
  ...
  { id:"synchrony",       name:"Synchrony Bank",          account:"High Yield Savings",         baseApy:3.30, branch:false, debit:true,  investing:false, fee:0, feeWaivable:false, minOpen:0,   slowTransfer:false, affiliateUrl:"https://www.synchronybank.com/banking/high-yield-savings-account/?ref=REPLACE_CJ_ID", notes:"Flat 3.30% (reduced from 3.50% in mid-2026), no conditions, no minimum. Unique: optional ATM debit card with $5/mo fee reimbursement — one of few HYSAs offering this with no requirements. 90-year history. 4.8-star iOS app. FDIC." },
...
// ─── TIERS ────────────────────────────────────────────────────────────────────
const TIERS = [
  { bank:"sofi",        label:"New Member Boost — 3.80% for 6 months (DD required)", apy:3.80, minBal:0, reqDD:true, minDD:0, newMoney:false, newCustomerOnly:true, sort:0 },
  ...
  { bank:"axos",        label:"Summit Savings (3.75% — no conditions)",            apy:3.75, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:0 },
  ...
  { bank:"axos",        label:"Base Rate (ONE bundle, no requirements met)",       apy:1.00, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:3 },
  { bank:"openbank",    label:"Standard Rate ($500 min to open)",                  apy:3.80, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
  { bank:"bread",       label:"Standard Rate ($100 min to open)",                  apy:3.95, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
  ...
  { bank:"pnc",         label:"Standard Rate (all other customers)",               apy:0.04, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:2 },
  { bank:"capital_one", label:"Standard Rate (no conditions)",                     apy:3.00, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
  { bank:"ally",        label:"Standard Rate (no conditions)",                     apy:3.00, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
  ...
  { bank:"amex",        label:"Standard Rate (no conditions)",                     apy:3.10, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
  ...
  { bank:"barclays",    label:"Top Tier ($250,000+ balance)",                      apy:3.80, minBal:250000, reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
  { bank:"barclays",    label:"Standard Rate (under $250,000)",                    apy:3.65, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:2 },
  ...
  { bank:"etrade",      label:"Standard Rate (no conditions)",                     apy:3.50, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:2 },
  ...
  { bank:"synchrony",       label:"Standard Rate (no conditions, optional debit)",     apy:3.30, minBal:0,      reqDD:false, minDD:0,    newMoney:false, newCustomerOnly:false, sort:1 },
...
function getQualifyingAPY(bank, answers) {
  ...
  for (const tier of bankTiers) {
    ...
    if (tier.monthlyFee) {
      ...
      const grossInterest = (boostedBal * tier.apy / 100) + (remainderBal * 3.10 / 100);
      ...
      if (netEffectiveApy <= 3.10) continue;
